...
/**
 * This class is a carbon copy of java.text.MessageFormat, except that the internal 
 * class MessageFormatElement and the local variables has been made public.
 * This is for using with the {@link olmgui.output.OLMDialoguePane} class, ie being able to use
 * the formatting power of MessageFormat with the displaying power of StyledDocument.
 * 
 * @see	olmgui.output.OLMDialoguePane#addItem(String, String, Object[]) for a description 
 * 		of the procedure
 *  
 ...
 */
public class OLMMessageFormat extends Format
{
    ...
    */
     ...
     * Variables
     */
    public MessageFormatElement[] elements;
    /**
     * Leader text.
     */
    ...
    {
        // I've commented this field out, in order to avoid conflict with the original one
        ...
        // Argument will be checked to make sure it is an instance of this class.
        Class formatClass;
        ...
        /**
         * @return Returns the formatClass.
         */
        ...
        public static class Field extends Format.Field
        {
             ...
             */
            public static final OLMMessageFormat.Field ARGUMENT = new OLMMessageFormat.Field("argument");
                                    ...
                                    Vector elts, Locale locale)
      {
        ...
        return index;
          ...
          public Object clone ()
          {
              OLMMessageFormat c = (OLMMessageFormat) super.clone ();
          ...
          {
            if (! (obj instanceof OLMMessageFormat))
              return false;
            OLMMessageFormat mf = (OLMMessageFormat) obj;
          ...
          {
            OLMMessageFormat mf = new OLMMessageFormat (pattern);
            StringBuffer sb = new StringBuffer ();
            FieldPosition fp = new FieldPosition (NumberFormat.INTEGER_FIELD);
            return mf.formatInternal(arguments, sb, fp).toString();
          }
          ...
          public final StringBuffer format (Object arguments[], StringBuffer appendBuf,
                            FieldPosition fp)
          {
            return formatInternal(arguments, appendBuf, fp);
          }
            ...
            if (formatter != null)
              {
                ...
                OLMMessageFormat mf = new OLMMessageFormat ();
                mf.setLocale(locale);
           ...
           */
          public OLMMessageFormat(String pattern)
          {
           ...
           * @since 1.4
           */
          public OLMMessageFormat(String pattern, Locale locale)
          {
            this.locale = locale;
            ...
            if (formatter instanceof ChoiceFormat)
              {
                ...
                OLMMessageFormat subfmt = new OLMMessageFormat ();
