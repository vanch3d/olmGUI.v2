...
public class StopWatch 
{
    ...
    public String toString() {
        StringBuffer sb =
            new StringBuffer(
                id + ": StopWatch: running time (secs)=" + getTotalTimeSecs() + "; ");
        try {
            ...
            for (int i = 0; i < tasks.length; i++) {
                ...
                long percent =
                    Math.round((100.0 * tasks[i].getTimeSecs()) / getTotalTimeSecs());
                sb.append("=" + percent + "%");
            }
        }
    ...
    public String prettyPrint() {
        ...
        sb.append("\n-----------------------------------------\n");
        sb.append("StopWatch: running time (secs)=" + getTotalTimeSecs() + " for " + id + "\n");
        try {
            TaskInfo[] tasks = getTaskInfo();
